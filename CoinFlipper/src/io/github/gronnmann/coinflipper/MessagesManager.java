...
public class MessagesManager {
	public enum Message {NO_PERMISSION, CMD_PLAYER_ONLY, PLAYER_NOT_FOUND, HEADS, TAILS, WRONG_MONEY, MIN_BET, MAX_BET, 
		...
		BET_CHALLENGE_CANTSELF, BET_CHALLENGE_NOMONEY,
		BET_WON, BET_LOST, BET_TITLE_VICTORY, BET_TITLE_LOSS,
		...
		CREATION_MONEY_COLOR, CREATION_MONEY_T1, CREATION_MONEY_T2, CREATION_MONEY_T3, CREATION_MONEY_T4, CREATION_MONEY_T5, CREATION_MONEY_T6,
		CREATION_MONEY_LEFTTOADD, CREATION_MONEY_RIGHTTOREMOVE,
		CREATION_MONEY_CUSTOM, CREATION_MONEY_CUSTOM_DESC, CREATION_MONEY_CUSTOM_SPEC, CREATION_MONEY_CUSTOM_NOTNUM, CREATION_MONEY_CUSTOM_SUCCESS,
