...
public class MessagesManager {
	public enum Message {NO_PERMISSION, CMD_PLAYER_ONLY, PLAYER_NOT_FOUND, HEADS, TAILS, WRONG_MONEY, MIN_BET, MAX_BET, 
		...
		CREATION_MONEY_CUSTOM, CREATION_MONEY_CUSTOM_DESC, CREATION_MONEY_CUSTOM_SPEC, CREATION_MONEY_CUSTOM_TOOMUCH, CREATION_MONEY_CUSTOM_TOOLITTLE, CREATION_MONEY_CUSTOM_NOTNUM, CREATION_MONEY_CUSTOM_SUCCESS,
